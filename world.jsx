...
const WORLD_HOTSPOTS = [
  {
    ...
    short: "CS student at UI · AI QA at HyrPilot · SWE Intern at Datara. Click to know me.",
    lead: "Final-year CS student at Universitas Indonesia, working in AI quality assurance and fullstack engineering, and teaching algorithms on the side.",
    connect: [
    ...
    experience: [
      { role:'AI Quality Assurance',
        org:'HyrPilot · Remote',
        date:'Sep 2026 – Now',
        desc:'Test AI job-matching agent: hallucination & regression checks, prompt caching, latency.' },
      { role:'Software Engineer Intern',
        org:'PT Datara Teknologi Solusi',
        date:'2026 – Now',
        desc:'Multi-tenant booking & POS SaaS: Laravel, React, WhatsApp API, QRIS.' },
      { role:'Teaching Assistant · DAA',
        org:'Fasilkom UI',
        date:'2026 – Now',
        desc:'Guided students in implementing and analyzing divide & conquer, greedy, and dynamic programming algorithms.' },
      { role:'Chairman',
  ...
  },
  {
    ...
    groups: [
      ...
      { n:'05', t:'Testing & QA',
        items:['AI Output Evaluation','LLM Regression Testing','Prompt Optimization · Caching','PHPUnit','Vitest · Testing Library','Jest','Mutation Testing','BDD · Cucumber','JMeter · k6','SonarQube','SAST / DAST · OWASP ZAP'] },
      { n:'06', t:'Tools & DevOps',
